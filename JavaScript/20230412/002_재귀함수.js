...
// 실무에서는 반복문 사용하시길 권해드립니다. 알고리즘 문제에서는 간혹 재귀함수를 호출해야 할 일이 있습니다.
...
// 누적합(sigma) 이렇게 일일이 순회하지 않고 구할 수 있는 값이기 때문에 2개다 비효율적인 코드입니다. 특히 소수(prime number)구하는 문제 같은 곳에서 2중 for문 사용하는 것도 매우 비효율적입니다.

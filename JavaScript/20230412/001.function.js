...
// length가 parameter의 수인 것을 확인했습니다.
...
함수((c = 300));
함수((a = 100), (c = 300));
함수((a = 100), (b = 300), (c = 200));
함수((a = 100), (c = 200), (b = 300)); // 안됩니다.

// 3. roro기법 원리 설명
// roro 기법? 입력되는 argument가 매우 많은 함수의 경우 호출하는 쪽에서 어떤 값이 들어가는지 명확히 알기 어렵고 읽기도 어렵다.
window.addNewControl("Title", 20, 50, 100, 50, true);
// 여러분들이 코드를 쭉  읽어 내려가다가 hello 함수를 만났습니다. 기분이 어떨까요? (이렇게 함수명을 짜면 힘들다.)
// python 형식입니다.
...
// 살짝 심화
// 위 코드에서 로그인정보({})를 호출 했을 때에는 error가 안나지만 로그인정보()를 호출하면 error가 납니다.
